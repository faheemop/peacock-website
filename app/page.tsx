...
export default function Page() {
  ...
  return (
    <div className="main-container w-full bg-[#fff] relative mx-auto my-0">
      {/* Header Section */}
      <div className="flex w-full pt-[16px] px-6 md:px-12 lg:px-[152px] 2xl:px-[200px] pb-px flex-col items-start flex-nowrap bg-[#faf7f2] border-solid border-t border-t-[#e5e7eb] relative z-[163]">
        <div className="flex h-[40px] justify-between items-center self-stretch shrink-0 flex-nowrap relative z-[164]">
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              className="w-[40px] h-[40px] flex items-center justify-center text-[#364153]"
      ...
      <div className="flex flex-col items-start bg-[#faf7f2]">
        ...
        <div className="w-full h-[400px] md:h-[550px] lg:h-[720px] 2xl:h-[850px] relative overflow-hidden">
          ...
          <div className="flex w-full h-full justify-center items-center relative z-[20] px-6">
            <div className="text-center">
              <h1 className="text-3xl md:text-5xl lg:text-[72px] 2xl:text-[84px] font-['Inter'] text-white leading-tight">Craft Coffee, <br /> Delivered Fresh</h1>
        ...
        <div className="flex w-full flex-col gap-6 md:gap-[32px] items-center bg-[#faf7f2] pb-12 md:pb-[80px] px-6 md:px-12 lg:px-[152px] 2xl:px-[200px]">
        ...
        {/* FOOTER SECTION */}
        <div className="w-full bg-[#803144] pt-12 md:pt-[80px] pb-[40px] px-6 md:px-12 lg:px-[152px] 2xl:px-[200px]">
